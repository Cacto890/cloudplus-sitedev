...
export default function PL01Page() {
  ...
  return (
    <main className="min-h-screen bg-black relative flex items-center justify-center p-4">
      ...
      <div className="flex flex-col gap-8 items-center z-10 max-w-7xl w-full">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3 flex-wrap">
              <Tiny5Button onClick={handleFormat} className={`${textColor} hover:text-red-500`}>
                FORMAT
              </Tiny5Button>
              <Tiny5Button onClick={handleMinify} className={`${textColor} hover:text-red-500`}>
                MINIFY
              </Tiny5Button>
        ...
        {error && (
          <div className="text-red-500 opacity-75 text-sm max-w-2xl" style={{ fontFamily: 'var(--font-tiny5)' }}>
            {error}
          </div>
        )}
