      ...
      <div className="flex flex-col gap-8 items-center z-10">
        ...
        {currentProject && !error && (
          <div className="flex flex-col gap-4 items-center mt-8">
            ...
            <div className={`${textColor} opacity-50 hover:opacity-100 transition-opacity`} style={{ fontFamily: 'var(--font-tiny5)' }}>
            ...
            {currentProject.route && (
              <Link href={currentProject.route}>
                <Tiny5Button className={`${textColor} hover:text-red-500 mt-4`}>
                  VISIT PROJECT
                </Tiny5Button>
              </Link>
            )}
